export default class Card {
  constructor({ element, userId, handleCardClick, handleDeleteClick, handleLikeCard }, cardConfig) {
...
setLike(count) {
  this._likes = count;
  this._likesCount = this._element.querySelector(this._cardConfig.likeCountSelector);
...
// Установка слушателей на элементы карточки
 ...
 // Метод генерирует и возвращает карточку
  generateCard() {    
    ...
    this._deleteButton = this._element.querySelector(this._cardConfig.deleteButtonSelector);
